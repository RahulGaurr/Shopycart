        ...
        <>
                ...
                <Typography 
                    style={{marginTop: 5, color: '#878787', fontSize: 14}}>
                        8 Ratings & 1 Review
                    <Box component='span'><img src={fassured} style={{width:77, marginLeft:20}} alt="assured-img"/></Box>
                 </Typography>
                 <Typography>
                 ...
                 <SmallText>
                    ...
                    <Typography> <StyledBadge /> Sign un for Flipkart Pay Later and get Flipkart Gift Card worth ₹100* Know More </Typography>
